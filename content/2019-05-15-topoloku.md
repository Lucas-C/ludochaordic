...
Tags: lang:fr, logic-puzzle, sudoku, topologie, personal-project, maths, jeux
...
1. chaque lettre doit appartenir à un groupe de lettres identiques **adjacentes** (horizontalement ou verticalement),
dont **la taille** totale est exactement **égale au nombre d'extrémités** de la lettre.
...
<table class="ko-ok"><thead><tr>
  ...
  <span class="comment">les L ne sont pas adjacents</span>
  ...
  <span class="comment">les L forment un groupe trop grand</span>
