Title: [EN] Fixing fonts that raise a "DFLT table doesn't satisfy the spec. LangSysCount is not zero" error in Firefox
Date: 2016-02-11 14:02
Tags: sed, fonts, firefox, otf, ttf, ttx, dflt, xml
