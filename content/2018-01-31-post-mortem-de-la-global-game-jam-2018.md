...
Avec l'équipe, nous aboutissons à une demi-douzaine d'idées, parmis lesquelles:
    ...
    * un "party game" TIC-TAC-BOUM ou 2 à 4 joueurs devant l'écran se renvoie une bombe
...
Une restitution des idées a alors lieux dans l'amphi, ou chaque projet décrit brièvement son concept et exprime ses besoins de compétences (dev, graphiste, sound designer, etc.).
...
- **samedi vers 9h30** : nous retrouvons dans la salle pour continuer à coder.
...
on réussit à intégrer une fonctionnalité dans la dernières heure (le "Hury Up!");
...
Après avoir pris le temps de faire le tour des projets des autres équipes et testé plusieurs jeux,
...
Et personnellement je n'ai vraiment pas vu passer le week-end passer.
...
- plutôt satisfait de l'adéquation du jeu au thème
...
- régler le problème des bruitages trop forts en terme de volume
