...
* [Jeux originaux](pages/jeux-de-role.html#jeux-originaux)
* [Traductions](pages/jeux-de-role.html#traductions)
* [Aides de jeu & scénarios](pages/jeux-de-role.html#aides-de-jeu-et-scenarios)
* [Logiciels & sites web](pages/jeux-de-role.html#logiciels)

Retrouvez également mes jeux sur ces plateformes : [drivethrurpg.com/ludochaordic](https://www.drivethrurpg.com/fr/publisher/35338/ludochaordic), [lucas-c.itch.io](https://lucas-c.itch.io).

<br>

<h2 id="jeux-originaux">Jeux originaux</h2>
...
<div class="uk-grid">
  ...
  <section class="uk-width-1-1 uk-width-small-1-2 uk-width-medium-1-3">
    <h2 class="uk-text-bold uk-text-primary">CHUM</h2>
    <img class="uk-align-center padded" src="images/2026/08/CHUM-four-third.jpg" alt="CHUM">
    <div class="uk-thumbnail-caption">
      <dl class="uk-description-list-list">
        <dt>Genre</dt><dd>Traduction d'un mini jeu de société avec des dés polyhédriques</dd>
        <dt>Pour</dt><dd>1 à 6 joueurs, sans MJ</dd>
      </dl>
      <ul>
        <li><a href="chum.html">Article de présentation de Genius Loci</a></li>
        <li><a href="https://lucas-c.itch.io/chum">Page itch.io dédiée</a></li>
      </ul>
      <blockquote>CHUM est un jeu de pêche qui utilise un ensemble de dés polyédriques standard : d6, d8, d10, d12, d20, d100.</blockquote>
      <blockquote>Conçu pour jouer en solo ou à plusieurs, l'objectif est simple : <strong>capturez le plus de poissons possible</strong> ! Pour cela, employez stratégiquement plusieurs tactiques : vers d'amorce, capture, remise en liberté et emploi des petits poissons comme appâts.</blockquote>
    </div>
  </section>
  <section class="uk-width-1-1 uk-width-small-1-2 uk-width-medium-1-3">
...
<h2 id="aides-de-jeu-et-scenarios">Aides de jeu & scénarios</h2>
...
<h2 id="logiciels">Logiciels &amp; sites web</h2>
