...
<br>
<small><em>(you can selectively display English articles by clicking <a href="?lang=en">there</a>, or using the tag filters)</em></small>
<br>
...
LISTENINGS = (
    {
        ...
        'url': 'https://amosroddy.bandcamp.com/album/citizen-sleeper-original-soundtrack'
    },
    {
        'date': '2026-06-11',
...
MG_TAG_PAGE_HEADER = '<a class="uk-float-right" href="pages/bienvenue.html#tagcloud">&gt; tag cloud &lt;</a>Articles avec le tag <b>%(tag)s</b>&nbsp;:'
